					...
					<div class="col-lg-12">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb justify-content-center">
								...
								<li class="breadcrumb-item"><a href="../Product Details/sellerAddNew.php">Add New Seller</a></li> 
							</ol>
						</nav>
					</div>
				</div>
			...
			<div class="section-top-border" align="left" style="inline-block">
				<div class="row">								
					<div class="col-lg-8 col-md-8">
						<h3 class="mb-30">Add New Seller</h3>
						<div class="row">
							<div class="col-lg-12">
						...
						<form action="../Product Details/sellerProcess.php" method="POST">
							<div class="mt-10">
							<input type="text" name="SELLER_NAME" placeholder="Name"
							onfocus="this.placeholder = ''" onblur="this.placeholder = 'Name'" required
							class="single-input">
							</div>
							<div class="mt-10">
								<input type="tel" name="SELLER_PH" placeholder="Phone No. example: 0123456789"
								onfocus="this.placeholder = ''" onblur="this.placeholder = 'Phone No.'" pattern="[0-1]{2}[0-9]{8}"required
								class="single-input">
							</div>
							<div class="mt-10">
									<input type="email" name="SELLER_EMAIL" placeholder="Email example: abc@def.com"
