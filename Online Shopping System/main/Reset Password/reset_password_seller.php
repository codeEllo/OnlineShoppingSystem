<?php
    ...
    if(empty($_GET['token'])|| !isset($_GET['token'])){
        ...
        $Sql = "SELECT seller_token,seller_name,seller_id,seller_email FROM SELLER";
        ...
        foreach ($Result as $Row) {
            ...
            if(password_verify($token, $Row["SELLER_TOKEN"])){
            ...
            if(empty($_POST["password1"])||empty($_POST["password2"])){
                ...
                if($Flag){
                    ...
                    if($ps1==$ps2){
                        ...
                        $mail->Subject = "Password Reset Request For Admin : ".$Username;
                        ...
                        if($mail->Send()) {
                            ...
                            $Sql = "UPDATE SELLER SET seller_token=null,seller_password=:pass,modified_at=systimestamp,seller_status=1 WHERE seller_id=:id";
                            $Stmt=$conn->prepare($Sql);
                    ...
                    <div class="col-md-8 col-lg-5 col-xl-4">
                        <div class="card" style="background-color: rgba(0,0,0,.8);color: #fff;">
                            <div class="card-body" >
                                ...
                                <div class="p-3">
                                    <h4 class="font-size-18 mt-2 text-center">Resseting Your Admin Password</h4>
