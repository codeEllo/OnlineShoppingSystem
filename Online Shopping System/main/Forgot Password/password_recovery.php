    ...
    if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        if(empty($_POST["useremail"])){
            ...
            if(!checkEmail($UserEmail)){
                ...
                $Sql = "SELECT cust_id,cust_name FROM CUSTOMER WHERE cust_email=:email";
                ...
                if(count($Result)==1){
                    ...
                    $NewToken = TokenCalculation($conn,$Date);
                    ...
                    $mail->IsHTML(true);
                    $mail->AddAddress($UserEmail,$Result[0]["CUST_NAME"]);
                    $mail->SetFrom("info@System.com", "Our Online Shopping");
                    $mail->addReplyTo('info@example.com', 'Information');
                    $mail->addCC('cc@example.com');
                    $mail->Subject = "Password Reset Request For User : ".$Result[0]['CUST_NAME'];
                    $content = "<p>Did you request a password recovery?</b>
                                <p>Click <a href='localhost/Project/main/Reset Password/reset_password.php?token=".$TokenWithTime."'> Here</a> to reset your account.</p>
                    ...
                    if($mail->Send()) {
                        ...
                        $Sql = "UPDATE CUSTOMER SET cust_token=:token,modified_at=systimestamp WHERE cust_id=:id";
                        $Stmt=$conn->prepare($Sql);
                        $Stmt->bindvalue('token',$PickedToken,PDO::PARAM_STR);
                        $Stmt->bindvalue('id',$Result[0]["CUST_ID"],PDO::PARAM_STR);
                        $Stmt->execute();
...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8">
        <title>Recover Password | Shion House</title>
    ...
    <body>
        ...
        <!-- Loader -->
         ...
         <!-- Begin page -->
         <div class="accountbg" style="background: url('../../assets/img/bg/bg4.jpg');background-size: cover;background-position: center;"></div>
                    ...
                    <div class="col-md-8 col-lg-6 col-xl-4">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="text-black text-center">Remember It ? <a href="../Login/login.php" class="font-weight-bold text-primary"> Sign In Here </a> </p>
