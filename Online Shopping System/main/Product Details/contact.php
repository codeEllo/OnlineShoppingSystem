...
<title>Contact | Shion House</title>
                ...
                <div class="container-fluid">
                    <div class="menu-wrapper d-flex align-items-center justify-content-between">
                        <div class="header-left d-flex align-items-center">
                            <!-- Logo -->
                            <div class="logo">
                                <a href="../Product Details/home.html"><img src="../../assets/img/logo/logo.png" alt=""></a>
                            </div>
                            <!-- Main-menu -->
                            <div class="main-menu  d-none d-lg-block">
                                <nav>
                                    <ul id="navigation">
                                        <li><a href="../Product Details/home.html">HOME</a></li> 
                                        <!--<li><a href="shop.html">shop</a></li>-->
                                        <li><a href="../About/about.php">ABOUT</a></li>
                                        <li><a href="#">PRODUCT</a>
                                            <ul class="submenu">
                                                <li><a href="../Product Details/productAddNew.php">Add New Product</a></li>
                                                <li><a href="../Product Details/productDetails.php">Product Details / Update</a></li>
                                            </ul>
                                        </li>
										<li><a href="../Product Details/orderList.php">Order's Details</a></li>
                                        <li><a href="../Product Details/contact.php">Contact</a></li>
                                    </ul>
                                </nav>
                            </div>   
                        </div>
                    ...
                    <div class="col-lg-12">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb justify-content-center">
                                <li class="breadcrumb-item"><a href="../Product Details/home.html">Home</a></li>
                                <li class="breadcrumb-item"><a href="../Product Details/contact.php">Contact</a></li> 
                            </ol>
                        </nav>
                    </div>
                </div>
